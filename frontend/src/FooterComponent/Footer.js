      ...
      <div className="container mx-auto px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <p className="text-gray-300">
                Our Fashion Shop is an online store offering high-quality fashion items
                at reasonable prices with the best service.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                <li>📞 Phone: 092-256-7600</li>
                <li>📧 Email: 64405@gmail.com</li>
                <li>📍 Address: 123 Fashion Street, Pattani 94000</li>
              </ul>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center text-gray-300">
            <p>© 2024 Fashion Shop. All rights reserved.</p>
          </div>
        </div>
      </div>
    </footer>
